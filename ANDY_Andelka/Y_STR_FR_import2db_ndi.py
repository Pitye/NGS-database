...
def main():
    ...
    reports_directory = os.path.normpath('C:/NGS_forensic_database/Y_STR_import2db')
    no_reads_for_validation_Y = 150
    CheckIfSampleInDatabase = True
    dbPass = 'XXX'
    
    Y_STR_FR_import2db(in_directory, out_directory, xml_directory, CSV_CE_directory, reports_directory, no_reads_for_validation_Y, CheckIfSampleInDatabase, dbPass)


def Y_STR_FR_import2db(in_directory, out_directory, xml_directory, CSV_CE_directory, reports_directory, no_reads_for_validation_Y, CheckIfSampleInDatabase, dbPass):
    print('please wait...')
    ...
    report_path_name = reports_directory + os.path.normpath('/') + 'report_Y_STR_import2db' + dt_string + '.csv'
    report_path_name_xls = reports_directory + os.path.normpath('/') + 'report_Y_STR_import2db' + dt_string + '.xls'
    ...
    for sample_name_Y in sample_names_Y:
        ...
        #print (head_Y_id)
            ...
            #print (sample_name_Y, 'was NOT inserted, entry already exists in Y_database' )
            f.writelines(["\n" + sample_name_Y + "," + " was NOT inserted - entry already exists in database"])
