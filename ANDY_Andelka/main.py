...
###todo - open file ad to mode 3
    ...
    def generateMode1Widget(self):
        ...
        self.mode1labelDir1 = QLabel(home + os.path.normpath('/NGS_forensic_database/xlsx_detail_reports'))
        ...
        self.mode1labelDir2 = QLabel(home + os.path.normpath('/NGS_forensic_database/csv_output'))
        ...
        self.mode1labelDir3 = QLabel(home + os.path.normpath('/NGS_forensic_database/xml_CE'))
        ...
        self.mode1labelDir4 = QLabel(home + os.path.normpath('/NGS_forensic_database/csv_CE'))
    ...
    def generateMode2Widget(self):
        ...
        self.mode2labelDir2 = QLabel(home + os.path.normpath('/NGS_forensic_database/relationship_LR_estimation/STR_lenght_frequencies'))
        ...
        self.mode2labelDir3 = QLabel(home + os.path.normpath('/NGS_forensic_database/relationship_LR_estimation/reports'))
    ...
    def generateMode3Widget(self):
        ...
        self.mode3labelFile1 = QLabel(home + os.path.normpath('/NGS_forensic_database/print_samples/print_sample.txt'))
        ...
        self.mode3labelFile2 = QLabel(home + os.path.normpath('/NGS_forensic_database/print_samples/locus_order.txt'))
        ...
        self.mode3labelDir3 = QLabel(home + os.path.normpath('/NGS_forensic_database/print_samples/prints'))
    ...
    def generateMode4Widget(self):
        ...
        self.mode4labelFile1 = QLabel(home + os.path.normpath('/NGS_forensic_database/delete_samples/delete_sample.txt'))
